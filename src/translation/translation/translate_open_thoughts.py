...
def main():
    ...
    translated_output_data_dir = os.path.join(data_dir, "open_thoughts")
    ...
    dataset = datasets.load_dataset("open-thoughts/OpenThoughts-114k", split="train")
    ...
    if all_results:
        ...
        output_path = os.path.join(
            translated_output_data_dir, "open_thoughts-114K.parquet"
        )
